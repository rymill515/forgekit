...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "A free planner for watch modders. Configure your build, see the cost live, and track every part." },
      { name: "twitter:description", content: "A free planner for watch modders. Configure your build, see the cost live, and track every part." },
